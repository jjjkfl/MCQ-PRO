...
router.post('/school/students', authorize('school_admin'), schoolAdminCtrl.createStudent);
router.patch('/school/students/:id', authorize('school_admin'), schoolAdminCtrl.updateUser);
router.get('/school/teachers', authorize('school_admin'), schoolAdminCtrl.getTeachers);
router.post('/school/teachers', authorize('school_admin'), schoolAdminCtrl.createTeacher);
router.patch('/school/teachers/:id', authorize('school_admin'), schoolAdminCtrl.updateUser);
